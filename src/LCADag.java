...
public class LCADag {
    ...
    private boolean hasCycle;		//check cycle in graph
    ...
    public int findLCA(int v, int w) {
        ...
        // cycle through the BFS paths, and add common ancestors to arrayList
    ...
    // Must start from end of Binary Tree and search in reverse to find LCA
